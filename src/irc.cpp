...
void ThreadIRCSeed()
{
    ...
    RenameThread("MasterMint-ircseed");
...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #MasterMintcoinTEST\r");
            Send(hSocket, "WHO #MasterMintcoinTEST\r");
        } else
        {
	    LogPrintf("JOIN #MasterMintcoin\n");
            // randomly join #MasterMintcoin00-#MasterMintcoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #MasterMintcoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #MasterMintcoin%02d\r", channel_number).c_str());
        };
