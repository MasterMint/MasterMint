...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeMMAmount"))
        settings.setValue("nAnonymizeMMAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeMMAmount = settings.value("nAnonymizeMMAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeMMAmount"))
        SoftSetArg("-anonymizeMasterMintamount", settings.value("nAnonymizeMMAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeMMAmount:
            nAnonymizeMMAmount = value.toInt();
            settings.setValue("nAnonymizeMMAmount", nAnonymizeMMAmount);
            emit anonymizeMMAmountChanged(nAnonymizeMMAmount);
            break;
        default:
            break;
        }
